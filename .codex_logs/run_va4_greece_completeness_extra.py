...
LOG_PATH = ROOT / ".codex_logs" / f"greece_completeness_va4_extra_{TS}.log"
SUMMARY_PATH = ROOT / ".codex_logs" / f"greece_completeness_va4_extra_{TS}_summary.json"
...
def main() -> int:
    write(f"Greece completeness extra batch started {TS}")
    results = []
    ...
    write(f"Greece completeness extra batch summary: {SUMMARY_PATH}")
    return 0
